...
@Component({
  selector: 'app-sale-gift',
  templateUrl: './sale-gift.component.html',
  styleUrl: './sale-gift.component.css',
  providers: [ConfirmationService],

})
export class SaleGiftComponent {
  gifts: Gift[] = [];
  gift!: Gift;
  winners: Card[] = []
  card: Card | undefined
  ...
  ngOnInit() {
    this.router.events.subscribe((event) => {
      if (event instanceof NavigationEnd && event.urlAfterRedirects === '/giftSale') {
